...
%% -----------------------------
%% Variable definition (paramètres à une classe?)
%% -----------------------------
\def\cours{Modèles linéaires}
\def\sigle{ACT-2003}
\def\session{Automne 2018}
\def\auteur{Gabriel Crépeault-Cauchon}
\def\SectionColor{green!40!black}
...
%% -----------------------------
%% Tabular column type customization
%% -----------------------------
...
% Header
\fancyhead{} 	% Reset
\fancyhead[L]{Feuille de formules pour~ \cours ~(\textbf{\sigle})}
\fancyhead[R]{\auteur}
...
\hline
Source & \text{dl} & \text{Sum of squares} & \text{Mean squares} & f \\\hline
