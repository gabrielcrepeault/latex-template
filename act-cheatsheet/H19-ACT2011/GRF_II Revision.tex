...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        xtick={1},
        xticklabels={$K$},
        ytick={1.5,0.75,  0, -0.75},
        yticklabels={$K$ , $K - P_T$,0,$-P_{T}$},
        title={Option Put (\emph{short})},
        legend entries={Gain,Profit},
        legend style={at={(0.7,0.2)},anchor=north west},
        xmin = 0,
        xmax = 2,
        ymin = -2,
        ymax = 2]
        \addplot[mark=none, draw=LongColor, line width=1.5pt, densely dashed] coordinates { (0,1.5) (1,0) (2,0) };
        \addplot[mark=none, draw=LongColor, line width=1.5pt] coordinates { (0,0.75) (1,-0.75) (2,-0.75) };
    \end{axis}
\end{tikzpicture}
