...
\fancyfoot{}		% Reset
\fancyfoot[R]{\thepage}
\fancyfoot[L]{\fontsize{8}{8}\selectfont%
\href{https://github.com/gabrielcrepeault/latex-template}{\faGithub \  gabrielcrepeault/latex-template} \\ (dernière mise à jour : \today)}
